...
public class compilador/*@bgen(jjtree)*/implements compiladorTreeConstants, compiladorConstants {/*@bgen(jjtree)*/
  protected static JJTcompiladorState jjtree = new JJTcompiladorState();public static boolean bandera;
 ...
 /*@bgen(jjtree) iniciarAnalisisSintactico */
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      ...
      jj_consume_token(MAIN);
      jj_consume_token(LLAVEA);
                                converter.setContext(Converter.MAINBLOCK);
      label_2:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case CONSTANTE:
 ...
 jjtree.openNodeScope(jjtn000);Symbol s; Token a; int typeKind; String typeKindID; String id; String value = "$"; int valueKind;
    try {
      ...
      jj_consume_token(PCOMA);
                                  jjtree.closeNodeScope(jjtn000, true);
                                  jjtc000 = false;
                                 converter.insertVariable(typeKind, id, value, "$");
    } catch (Throwable jjte000) {
                  if (jjtc000) {
                    jjtree.clearNodeScope(jjtn000);
                    jjtc000 = false;
 ...
 boolean jjtc000 = true;
 jjtree.openNodeScope(jjtn000);Token t; boolean isFloat = false; int index = -1; String operacion = "";
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case IDENTIFICADOR:
        t = identificador();
 ...
 boolean jjtc000 = true;
 jjtree.openNodeScope(jjtn000);Token t; int typeKind; String id; String value; int valueKind;
    try {
      t = identificador();
                if(tabla.contains(t.image)){
      ...
      jj_consume_token(PCOMA);
                                                           jjtree.closeNodeScope(jjtn000, true);
                                                           jjtc000 = false;
                                                          converter.insertAssignment(id, value, "$");
    } catch (Throwable jjte000) {
          if (jjtc000) {
            jjtree.clearNodeScope(jjtn000);
            jjtc000 = false;
 ...
 boolean jjtc000 = true;
 jjtree.openNodeScope(jjtn000);Token t; String id; int kind;
    try {
      jj_consume_token(INPUT);
      jj_consume_token(PARENTA);
      t = identificador();
      ...
      jj_consume_token(PCOMA);
                           jjtree.closeNodeScope(jjtn000, true);
                           jjtc000 = false;
                          converter.inputElement(kind, id);
    } catch (Throwable jjte000) {
          if (jjtc000) {
            jjtree.clearNodeScope(jjtn000);
            jjtc000 = false;
 ...
 jjtree.openNodeScope(jjtn000);String op;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xfffffffe,0xfffffffe,0x17c,0x17c,0xc0000000,0xc0000000,0x800,0x1000,0x0,0x1000,0xf000,0xf000,0x1000,0x0,0x1000,0x1000,0x17c,0x80,0x17c,0x600,0x600,0x3f0000,0x17c,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0xf,0xf,0x8,0x8,0x0,0x0,0x0,0x0,0x3,0xb,0x0,0x0,0x0,0x3,0xb,0xf,0x8,0x0,0x8,0x0,0x0,0x0,0x8,};
   }
